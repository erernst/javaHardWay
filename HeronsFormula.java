public class HeronsFormula {
	...
	public static double triangleArea( int a, int b, int c ) {
		...
		return A;
	//the version that uses the function is about 20 lines shorter
	//it only took one more line of code to add this, if there wer not functions it would have taken 6 lines
	}
}